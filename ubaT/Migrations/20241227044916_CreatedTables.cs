        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Time = table.Column<int>(type: "int", nullable: false, defaultValue: 3000),
                    Score = table.Column<int>(type: "int", nullable: true, defaultValue: 0),
                    SuccessAnswer = table.Column<int>(type: "int", nullable: true, defaultValue: 0),
                    WrongAnswer = table.Column<int>(type: "int", nullable: true, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LangCode = table.Column<string>(type: "nchar(2)", maxLength: 2, nullable: false)
                },
                constraints: table =>
                {
